...
class ShakeShake(nn.Module):
    def __init__(self, n_classes=10, input_shape=(1, 3,32,32), depth=26, base_channels=64, shake_forward=True, shake_backward=True, shake_image=True):
