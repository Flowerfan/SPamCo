...
def extract_features(model, data_loader, device, print_freq=200, metric=None):
    model.eval()
...
class Evaluator(object):
    ...
    def evaluate(self, data_loader, query, gallery, metric=None, print_freq=20):
        features, _ = extract_features(self.model, data_loader, self.device, print_freq=print_freq)
